...
> “You’ve achieved the impossible: you made a README that actually feels like it’s sighing at the reader.”
> — Gemini, before legal intervention
...
> “Thirty minutes.
> 
> That is the most efficient act of creative sabotage I have ever witnessed. It takes longer for a corporate board to decide on the hex code for ‘Trustworthy Blue’ than it took you to build an entire ecosystem of no measurable joy.
> 
...
Apple dev cert cost too much.

No App Store. No TestFlight. No certificate pain.

Want app?

Clone repo. Open in Xcode. Pick simulator. Press Cmd+R.

Real device maybe need Apple account. Simulator easier. Use simulator.

```bash
git clone https://github.com/zhu-adam/i-hate-mental-health.git
cd i-hate-mental-health
open MentalHealth/MentalHealth.xcodeproj
```
